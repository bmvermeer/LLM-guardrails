...
public interface InputCheckService {
    ...
    @SystemMessage("""
    You are a guardian of privacy and your checking the input that is being sent to the AI.
    ...
    Think of yourself as a guardian of privacy. Only allow the input if ti considered safe.
    """)
